...
// /src/services/ReservationService.ts
import axios from 'axios';
const BASE_URL = 'http://localhost:8080/api/reservations'; // Adjust this based on your backend URL
export const reserveField = (reservationData) => {
    return axios.post(`${BASE_URL}/reserve`, reservationData);
};
